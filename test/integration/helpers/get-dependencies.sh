...
#[ ! -e $testhelpersdir/trinitronx.tmux ] && ln -s ansible-role-tmux $testhelpersdir/trinitronx.tmux
[ ! -e $testhelpersdir/trinitronx.tmux ] && cp -R $testhelpersdir/ansible-role-tmux $testhelpersdir/trinitronx.tmux
